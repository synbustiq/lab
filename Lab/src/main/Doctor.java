...
public class Doctor extends JFrame {
	...
	public void comboBox() {
		...
		try {
			...
			set = statement.executeQuery();
			while (set.next()) {
				comboBox_doctor.addItem(set.getString(2));
			}
		} catch (Exception e) {
			// TODO: handle exception
			e.printStackTrace();
	...
	public void refreshCombobox() {
		DefaultComboBoxModel<String> model = (DefaultComboBoxModel<String>) comboBox_doctor.getModel();
		model.getIndexOf(0);
	...
	public Doctor() {
		...
		comboBox_doctor = new JComboBox<String>();
		comboBox_doctor.setModel(new DefaultComboBoxModel<String>(new String[] { " " }));
		comboBox_doctor.setEditable(true);
		comboBox_doctor.setEnabled(false);
		comboBox_doctor.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				String name = comboBox_doctor.getSelectedItem().toString();
		...
		comboBox_doctor.setBounds(10, 60, 276, 43);
